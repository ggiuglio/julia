...
const RadioActionControls = ({ article, setOnEdit, articleOnEdit, deleteArticle, saveArticle, cancelEdit }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(RadioActionControls);